...
public class GoogleCloudCalculatorPage {
    ...
    @FindAll({@FindBy(xpath = "//div[contains(@class, 'md-select-menu-container') and contains(@class,'md-active')]/md-select-menu/md-content/md-option/div[contains(@class,'md-text')]")})
    private List<WebElement> activeSelectOptions;

    @FindAll({@FindBy(xpath = "//div[contains(@class, 'md-select-menu-container') and contains(@class,'md-active')]/md-select-menu/md-content/md-optgroup/md-option/div[contains(@class,'md-text')]")
    })
    ...
    public GoogleCloudCalculatorPage(WebDriver driver, int a) {
        this.driver = driver;
    ...
    public GoogleCloudCalculatorPage search(){
        WebElement searchButton = driver.findElement(By.xpath("//input[@aria-label='Search']"));
        searchButton.click();
        ...
        WebElement searchLink = driver.findElement(By.xpath("//b[text()='Google Cloud Pricing Calculator']"));
        searchLink.click();
        return new GoogleCloudCalculatorPage(driver, 1);
    }
    ...
    public String getResultCalculatorEstimateCost() {
